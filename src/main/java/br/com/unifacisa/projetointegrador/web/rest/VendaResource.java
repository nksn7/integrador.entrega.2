...
/**
 * REST controller for managing {@link br.com.unifacisa.projetointegrador.domain.Venda}.
 */
@RestController
    ...
    public ResponseEntity<Venda> partialUpdateVenda(
        ...
        Optional<Venda> result = vendaRepository
            ...
            .map(existingVenda -> {
                ...
                if (venda.getDescontoTotal() != null) {
                    existingVenda.setDescontoTotal(venda.getDescontoTotal());
                }
                if (venda.getFormaPagamento() != null) {
                    existingVenda.setFormaPagamento(venda.getFormaPagamento());
                }
                if (venda.getParcelas() != null) {
                    existingVenda.setParcelas(venda.getParcelas());
                }
                if (venda.getNotaFiscalEmitida() != null) {
                    existingVenda.setNotaFiscalEmitida(venda.getNotaFiscalEmitida());
                }
                if (venda.getEstatus() != null) {
                    existingVenda.setEstatus(venda.getEstatus());
                }
