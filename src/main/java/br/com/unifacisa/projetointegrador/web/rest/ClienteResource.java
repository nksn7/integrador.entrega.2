...
import br.com.unifacisa.projetointegrador.repository.ClienteRepository;
...
/**
 * REST controller for managing {@link br.com.unifacisa.projetointegrador.domain.Cliente}.
 */
@RestController
        ...
        Optional<Cliente> result = clienteRepository
            ...
            .map(existingCliente -> {
                if (cliente.getTipoPessoa() != null) {
                    existingCliente.setTipoPessoa(cliente.getTipoPessoa());
                }
                if (cliente.getNome() != null) {
                    existingCliente.setNome(cliente.getNome());
                }
                if (cliente.getRazaoSocial() != null) {
                    existingCliente.setRazaoSocial(cliente.getRazaoSocial());
                }
                ...
                if (cliente.getDataCadastro() != null) {
                    existingCliente.setDataCadastro(cliente.getDataCadastro());
                }
