...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.unifacisa.projetointegrador.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.unifacisa.projetointegrador.repository.UserRepository.USERS_BY_EMAIL_CACHE);
